...
var transform = exports.transform = function transform(schema, candidate, attributes) {
  return Object.assign(filterByKeys(schema, candidate), _lodash2.default.reduce(attributes, function (memo, value, key) {
    return Object.assign(memo, _defineProperty({}, key, _lodash2.default.isFunction(value) ? value(candidate) : value));
  }, {}));
};

var createSchema = exports.createSchema = function createSchema(schema) {
  return {
