...
var createSchema = exports.createSchema = function createSchema(definition) {
  var flat = _tsil2.default.flatten(definition);
  var nodes = flat.filter(function (node) {
    return node[_tsil2.default.VAL] && node[_tsil2.default.VAL].baseIsRequired !== undefined;
  });
